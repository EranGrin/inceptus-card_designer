...
var ImageDialog = Widget.extend({
    ...
    init: function (parent, media, options) {
        ...
        this.domain = this.options.domain || ['|', ['mimetype', '=', false], ['mimetype', this.options.document ? 'not in' : 'in', ['image/gif', 'image/jpe', 'image/jpeg', 'image/jpg', 'image/gif', 'image/png', 'image/svg']]];
        this.parent = parent;
        this.old_media = media;
        this.media = media;
        this.images = [];
    ...
    form_submit: function (event) {
        ...
        window[callback] = function (attachments, error) {
            ...
            _.each(attachments, function (record) {
                ...
                record.is_document = !(/gif|jpe|jpg|png|svg/.test(record.mimetype));
            });
